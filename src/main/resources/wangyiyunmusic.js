...
result = function(musicid){
    // csrf_token 和这个参数没有关系
    i2x = {ids: [musicid], level: "standard", encodeType: "aac", csrf_token: ""}
    // i2x = {"ids": [1317145930], "level": "standard", "encodeType": "aac", "csrf_token": "273284c0a85619521fe0a98f63dda585"}
